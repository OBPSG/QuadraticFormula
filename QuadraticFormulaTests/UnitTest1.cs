...
namespace QuadraticFormulaTests
{
    public class Tests
    {
        ...
        //[Test]
        ////Test for x^2 -2x -24 = 0. Factors into (x - 6)(x + 4)
        ...
        //[Test]
        ////Test for x^2 + 4x + 4 = 0. Factors into (x + 2)^2
        ...
        //[Test]
        ////Test for x^2 - 0.5x + 0.0625 = 0. Factors into (x - 0.25)^2
        ...
        //Begin Tests to determine if the final roots are calculated correctly
        //Remember that the order of the solutions is generated based on adding the discriminant first, then subtracting it
        [Test]
        //Test for x^2 + 10x + 24 = 0. Factors into (x + 6)(x + 4)
        //Discriminant value should be 4, so two real zeroes (-6 and -4)
        public void Test3_1()
        {
            ...
            results = Calculator.Calculate(a, b, c);
            Assert.AreEqual(results[0].Real, 0.0);
            Assert.AreEqual(results[1].Real, -4.0);
            Assert.AreEqual(results[1].Imaginary, 0.0);
            Assert.AreEqual(results[2].Real, -6.0);
            Assert.AreEqual(results[2].Imaginary, 0.0);
        }
        ...
        public void Test3_2()
        {
            ...
            results = Calculator.Calculate(a, b, c);
            Assert.AreEqual(results[0].Real, 0.0);
            Assert.AreEqual(results[1].Real, 6.0);
            Assert.AreEqual(results[1].Imaginary, 0.0);
            Assert.AreEqual(results[2].Real, -4.0);
            Assert.AreEqual(results[2].Imaginary, 0.0);
        }
        ...
        public void Test3_3()
        {
            ...
            results = Calculator.Calculate(a, b, c);
            Assert.AreEqual(results[0].Real, 1.0);
            Assert.AreEqual(results[1].Real, -2.0);
            Assert.AreEqual(results[1].Imaginary, 0.0);
        ...
        public void Test3_4()
        {
            ...
            results = Calculator.Calculate(a, b, c);
            Assert.AreEqual(results[0].Real, 1.0);
            Assert.AreEqual(results[1].Real, 0.25);
            Assert.AreEqual(results[1].Imaginary, 0.0);
            Assert.IsNull(results[2]);
        }
    }
